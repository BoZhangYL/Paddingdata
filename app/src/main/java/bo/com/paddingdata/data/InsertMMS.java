...
/*import com.insertMms.Telephony.Mms;
import com.insertMms.Telephony.Mms.Addr;
import com.insertMms.Telephony.Mms.Part;
import com.insertMms.Telephony.Threads;
import android.provider.Telephony;*/
...
/**
 * Created by bo.zhang on 2017/05/26   .
 */

public class InsertMMS extends Activity {

    private static final String IMAGE_NAME_1 = "src/main/asset/image_1.jpeg";
    private static final String IMAGE_NAME_2 = "src/main/asset/image_2.jpeg";
    ...
    private static final String AUDIO_NAME = "src/main/asset/audio_1.ogg";
    ...
    private static final String VIDEO_NAME = "src/main/asset/video_1.3gp";
...
/*        setContentView(R.layout.main);
        ...
        for (int i = 0; i < 5; ++i)
            insert(Mms.MESSAGE_BOX_INBOX, AttachmentType.IMAGE, i);*/
    }


    public void insert(Context mContext,int msgBoxType, int type, int idx) {
        long threadId = Telephony.Threads.getOrCreateThreadId(mContext, FROM_NUM + idx);
        ...
        cvMain.put(Mms.MESSAGE_SIZE, getSize(mContext,name_1) + getSize(mContext,name_2) + 512);  // suppose have 512 bytes extra text size
        ...
        try {
            ...
            if (!copyData(mContext,dataUri_1, name_1)) {
            ...
            if (!copyData(mContext,dataUri_2, name_2)) {
    ...
    private int getSize(Context mContext,final String name) {
        InputStream is = null;
        int size = 0;
    ...
    private boolean copyData(Context mContext,final Uri dataUri, final String name) {
